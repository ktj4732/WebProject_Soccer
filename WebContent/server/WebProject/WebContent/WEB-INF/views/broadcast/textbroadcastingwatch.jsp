                ...
                <div id="action">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                            	<td style="width:500px"><button type="button" style="width:480px ; font-size:1.2em;" id="tbbtn" class="btn btn-info">중계시작</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script> //스크립트1
    ...
    var url="ws://211.63.89.43:8090/soccer/board/textbroadcastserver";
	var ws;
