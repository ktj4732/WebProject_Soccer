...
<head>
    ...
    <link rel="stylesheet" href="/soccer/css/registmercenaryrecruit.css">
                ...
                <div class="subMenuBox">
                    <nav class="subMenu">
                        <ul>
                            ...
                            <li class="subMenuItem"><a href="mercenaryrecruit.html"
                                    style="background-color:rgb(15, 13, 13);">용병모집</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <div class="center">
        ...
        <div id="centerMainBox">
            ...
            <!-- 확인/미리보기 버튼 -->
            <div id="centerBox5">
                <input class="btn" id="writebtn1" type="button" value="확인" onclick="location.href='#'" ;>
                <input class="btn" id="writebtn2" type="button" value="미리보기" onclick="location.href='#'" ;>
            </div>
