...
import com.test.soccer.broadcast.BroadcastDAO1;
import com.test.soccer.broadcast.BroadcastDTO1;

@WebServlet("/schedule/leagueschedule.do")
public class LeagueSchedule extends HttpServlet {
...
//				System.out.println(totalPage);
		...
		if (n == 1) {
			...
			pagebar += String.format(
					"<a href=\"/soccer/schedule/leagueschedule.do?page=%d\" aria-label=\"Previous\">",
					n - 1);
			pagebar += " <span aria-hidden=\"true\">&laquo;</span>";
			pagebar += "</a>";
			pagebar += "</li>";
...
//				for(int i=1;i<totalPage;i++) {
		while (!(loop > blockSize || n > totalPage)) {
			...
			if (n == nowPage) {
				...
				pagebar += "<li>";
				pagebar += String.format("<a href=\"/soccer/schedule/leagueschedule.do?page=%d\">%d</a>", n,
						n);
				pagebar += "</li>";
		...
		if (n > totalPage) {
			...
			pagebar += "<li>";
			pagebar += String.format(
					"<a href=\"/soccer/schedule/leagueschedule.do?page=%d\" aria-label=\"Next\">", n);
			pagebar += " <span aria-hidden=\"true\">&raquo;</span>";
			pagebar += "</a>";
			pagebar += "</li>";
		}
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/schedule/leagueschedule.jsp");
