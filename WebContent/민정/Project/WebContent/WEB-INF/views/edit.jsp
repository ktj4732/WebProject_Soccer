...
<script src="${pageContext.request.contextPath}/js/jquery-1.12.4.js"></script>
    ...
    <div class="center">
            ...
            <div id="centerMainBox">
               <form name = "writeform" action="${pageContext.request.contextPath}/editok.do" method="POST" > 
                    <!-- 제목 입력 -->
                    <div id="centerBox1">
                    	
                        <span style=" position: relative;  margin-right: 36px;">제목 : </span>
                        <input type="text" name="title" id="title" size="70px" placeholder="제목" onclick="titleWrite();"required value="${dto.title}">
                    </div>

                    <!-- 내용 입력 -->
                    <div id="centerBox2"> 
                    	<span style="position: relative; bottom: 450px; margin-right: 40px;">내용: </span>         
                        <textarea  name="content" id="content" placeholder="content" cols="90" rows="17" required>${dto.content}</textarea>
                    </div>
					<br>
                    <!-- 파일첨부 -->
                    <div>
                    ...
                    <!-- 등록/목록 버튼 -->
                    <div id="centerBox4">            
                        <input type="button" value="수정" onclick="writeCheck();">
